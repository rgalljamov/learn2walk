...
WB_PROJECT_NAME = 'conti_refs'
WB_EXPERIMENT_NAME = '3d hip, no mirr, 8M - ramp refs'
WB_EXPERIMENT_DESCRIPTION = 'No Mirroring for the moment when a 3d hip is used! ' \
                            'Extend the thesis walker by an additional joint in the hip and ' \
                            'train him to follow the reference trajectories.'
...
# walker XML file
WALKER_MJC_XML_FILE = 'walker3d_flat_feet_hip3d.xml' # 'walker3d_flat_feet.xml' # 'walker3d_flat_feet_lowmass.xml' # 'walker3d_flat_feet_40kg_140cm.xml' #
...
PEAK_JOINT_TORQUES = [300, 300, 300, 300, 300] # [300]*4 # [50]*3 + [5] #
